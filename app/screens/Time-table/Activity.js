...
import {mainRoot, ProgressTab} from '../../constants/Tabs'
    ...
    <View style={{height:55, paddingTop:10, backgroundColor:'white', elevation:8}}>
      <View style={styles.container}>
        <TouchableOpacity style ={{ borderWidth:2, borderRadius:3, width:wdt*2/7,
            alignItems:'center', justifyContent:'center'}} onPress={() => Navigation.setRoot(mainRoot)}>
          <Text style={{color:'black', fontSize:20, fontStyle:'italic'}}>Plan</Text>
        </TouchableOpacity>

        <TouchableOpacity style ={{width:wdt*2/7, backgroundColor:'darkred', borderRadius:3, alignItems:'center', justifyContent:'center'}}>
          <Text style={{color:'white', fontSize:20, fontStyle:'italic'}}>Activity</Text>
        </TouchableOpacity>

        <TouchableOpacity style ={{ borderWidth:2, borderRadius:3, width:wdt*2/7, alignItems:'center', 
            justifyContent:'center'}} onPress={() => Navigation.setRoot({root:ProgressTab})}>
